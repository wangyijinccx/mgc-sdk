...
class GameController extends HomebaseController {
    ...
    public function _gameList() {
        ...
        foreach ($gamelist as $key => $val) {
            ...
            if(!empty ($urldata[$val['id']]['iosurl'])){
                $gamelist[$key]['downurl'] = $urldata[$val['id']]['iosurl'];
            }else if(!empty($urldata[$val['id']]['androidurl'])){
                $gamelist[$key]['downurl'] = $urldata[$val['id']]['androidurl'];
            }else{
                $gamelist[$key]['downurl'] = "";
            }
            //ios下载二维码图片
