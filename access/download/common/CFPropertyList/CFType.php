...
class CFDate extends CFType {
     ...
     * @param integer $format format the timestamp is specified in, use {@link TIMESTAMP_APPLE} or {@link
     *                        TIMESTAMP_UNIX}, defaults to {@link TIMESTAMP_APPLE}
     *
     ...
     * @param integer $value  timestamp to set
     * @param integer $format format the timestamp is specified in, use {@link TIMESTAMP_APPLE} or {@link
     *                        TIMESTAMP_UNIX}, defaults to {@link TIMESTAMP_UNIX}
     *
     * @return void
